...
public class EmailService {
    ...
    public void sendVerificationCode(String email, String code) {
        try {
            ...
            helper.setTo(email);
            helper.setSubject("Who Dat Idols - Hesap Doğrulama Kodu");
    ...
    private String buildVerificationEmailTemplate(String code) {
        return "<div style='font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:20px;background:#222;color:#fff;border-radius:10px;'>"
                ...
                + "</div>"
                + "</div>"
                + "<p>Bu kod güvenlik nedeniyle 2 dakika içinde geçerliliğini yitirecektir.</p>"
                ...
                + "<p style='color:#999;font-size:14px;text-align:center;'>© 2026 Who Dat Idols? Tüm hakları saklıdır.</p>"
                + "</div>";
    }
}