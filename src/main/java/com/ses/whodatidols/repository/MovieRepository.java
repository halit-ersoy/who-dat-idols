...
public class MovieRepository {
    ...
    private void ensureSchema() {
        try {
            ...
            jdbcTemplate.execute(
                    "IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'Movie' AND COLUMN_NAME = 'IsHidden') "
                            +
                            "BEGIN " +
                            "    ALTER TABLE Movie ADD IsHidden BIT DEFAULT 0 NOT NULL; " +
                            "END");
